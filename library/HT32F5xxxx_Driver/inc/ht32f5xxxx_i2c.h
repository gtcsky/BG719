...
I2C_MASTER_SEND_START=((u32)0x00180001),
I2C_MASTER_RECEIVER_MODE=((u32)0x00180004),
I2C_MASTER_TRANSMITTER_MODE=((u32)0x003A0004),
I2C_MASTER_RX_NOT_EMPTY=((u32)0x00190000),
I2C_MASTER_RX_NOT_EMPTY_NOBUSY=((u32)0x00010000),
I2C_MASTER_TX_EMPTY=((u32)0x003A0000),
I2C_MASTER_RX_BUFFER_FULL=((u32)0x001D0000),
I2C_SLAVE_ACK_TRANSMITTER_ADDRESS=((u32)0x002A0004),
I2C_SLAVE_ACK_RECEIVER_ADDRESS=((u32)0x00080004),
I2C_SLAVE_ACK_GCALL_ADDRESS=((u32)0x00080008),
I2C_SLAVE_RX_NOT_EMPTY=((u32)0x00090000),
I2C_SLAVE_RX_NOT_EMPTY_STOP=((u32)0x00010002),
I2C_SLAVE_TX_EMPTY =((u32)0x002A0000),
I2C_SLAVE_RX_BUFFER_FULL=((u32)0x000D0000),
I2C_SLAVE_RECEIVED_NACK =((u32)0x00080200),
I2C_SLAVE_RECEIVED_NACK_STOP=((u32)0x00000202),
I2C_SLAVE_STOP_DETECTED=((u32)0x00000002)
}I2C_Result_Stts;
