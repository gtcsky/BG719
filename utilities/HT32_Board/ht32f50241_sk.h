...
#define	I2C0_SCL_GPIO				(HT_GPIOB)
#define	I2C0_SCL_GPIO_ID				(GPIO_PB)
#define 	I2C0_SCL_AFIO_PIN    			(AFIO_PIN_0)
#define 	I2C0_SCL_AFIO_MODE    		(AFIO_FUN_I2C)

#define	I2C0_SDA_GPIO				(HT_GPIOB)
#define	I2C0_SDA_GPIO_ID			(GPIO_PB)
#define 	I2C0_SDA_AFIO_PIN    			(AFIO_PIN_1)
